...
#####---------creating the dictonary from above list----###############

dict={'patient_name':pat_nme,'patient_id':pat_id,'height':ht,'temparature':temp}

#######------converting the dictonary to dataframe------------#############
...
######-----------randomly add the disease to 10 patient-----------############
import random
...
#####----------randomly add the hospital to 10 patients------###########
